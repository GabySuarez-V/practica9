//Previo9: Fuentes de luz	Suarez Velasco Gabriela
//Fecha de entrega : 29 de marzo de 2025		317313521
...
int main()
{
	...
	//Model Dog((char*)"Models/jarron.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::translate(model, glm::vec3(2.5f, -3.65f, 2.5f));
